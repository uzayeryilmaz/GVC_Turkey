...
for (year in 2000:2014) {
  load(paste("C:/Users/HP/Desktop/wiod-paper/wiot_r_Nov16/WIOT",year,"_October16_ROW.RData",sep = ""))
  print(year)
  wiot = fix_rows(wiot)
  wiot = fix_cols(wiot)
...
#formattable(manufac_table)
#round(rowMeans(manufac_table_perc[eu_iso]),1)
